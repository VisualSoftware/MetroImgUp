...
Public Class ImageClipboard
    ...
    Public Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        Dim picname As String
        picname = "Data\" & Now.Year & "-" & Now.Month & "-" & Now.Day & "-" & Now.Hour & "-" & Now.Minute & "-" & Now.Second & ".png"
        PictureBox1.BackgroundImage = TakeImage()
        PictureBox1.BackgroundImage.Save(picname, System.Drawing.Imaging.ImageFormat.Png)
        My.Forms.Form1.TextBox3.Text = My.Application.Info.DirectoryPath & "\" & picname
    End Sub

    Private Function TakeImage()
        Return TakeImage(0, 0, Screen.PrimaryScreen.Bounds.Width, Screen.PrimaryScreen.Bounds.Height)
    End Function
    ...
    Private Function TakeImage(ByVal X As Integer, ByVal Y As Integer, ByVal Width As Integer, ByVal Height As Integer)
        ...
        Me.Opacity = 0
        Dim Opacity1 As Double = My.Forms.Form1.Opacity
        My.Forms.Form1.Opacity = 0
        Dim Opacity2 As Double = My.Forms.Form2.Opacity
        My.Forms.Form2.Opacity = 0
        Dim Opacity5 As Double = My.Forms.About.Opacity
        My.Forms.About.Opacity = 0
        Dim Opacity7 As Double = My.Forms.PasswordManager.Opacity
        My.Forms.PasswordManager.Opacity = 0
        ...
        Me.Opacity = Opacity
        My.Forms.Form1.Opacity = Opacity1
        My.Forms.Form2.Opacity = Opacity2
        My.Forms.About.Opacity = Opacity5
        My.Forms.PasswordManager.Opacity = Opacity7
        Return Img
    End Function
    ...
    Private Sub ImageClipboard_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
        My.Forms.Form1.ButtonX27.Enabled = True
    End Sub
...
#End Region
    ...
    Private Sub Bar1_MouseUp(sender As Object, e As MouseEventArgs) Handles Bar1.MouseUp
    ...
    Private Sub Bar1_MouseDown(sender As Object, e As MouseEventArgs) Handles Bar1.MouseDown
        If e.Button = MouseButtons.Left Then
    ...
    Private Sub ImageClipboard_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Bar1.BackColor = System.Drawing.Color.FromArgb(180, 180, 180)
    End Sub
